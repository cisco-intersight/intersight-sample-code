...
def create_snmp_policy():
    ...
    # Create an instance of organization, snmp user and snmp trap.
    ...
    snmp_trap = SnmpTrap(community="trapCommString",
    ...
    snmp_policy.access_community_string = "acc_comm_string"
